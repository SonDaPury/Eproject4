...
namespace backend.Service
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<object> CreateOrder(CreateOrder Order)
        {
            ...
            {
                UserID = Order.UserID,
                SouresID = Order.SourceID,
                TotalPrice = Order.Price,
                CreatedAt = DateTime.Now,
                PaymentID = DateTime.Now.Ticks.ToString(),
                Status = true
            };
            string json = JsonConvert.SerializeObject(Order1, Newtonsoft.Json.Formatting.Indented);
            ...
            vnpay.AddRequestData("vnp_OrderInfo", json);
        ...
        public async Task<object> ConfirmPayment(ConfirmPayment confirmPayment)
        {
            ...
            if (checkSignature)
            {
                ...
                {
                    Order payment = JsonConvert.DeserializeObject<Order>(confirmPayment.vnp_OrderInfo);
